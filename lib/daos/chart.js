...
var Chart = function() {
     ...
     * @return {undefined}
     */
    this.getAllCompleteCharts = function(page, cb) {
    ...
    this.getAllCompleteChartsByChartSlug = function(slug, cb) {
        var uri = app.get('admin_uri') + '?action=rip_charts_get_all_complete_charts_by_chart_slug&slug=' + slug;
        var hash = hasher.getHash(uri);
        console.log(uri);
    ...
    this.getCompleteChartBySlug = function(slug, cb) {
        var uri = app.get('admin_uri') + '?action=rip_charts_get_complete_chart_by_chart_archive_slug&slug=' + slug;
        var hash = hasher.getHash(uri);
