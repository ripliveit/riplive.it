...
var ArtistDao = function() {
     ...
     * @return {undefined}
     */
    this.getAllArtists = function(count, page, divide, cb) {
        var uri = app.get('admin_uri') + '?action=rip_artists_get_all_artists&count=' + count;
        uri += '&page=' + page;
     ...
     * @return {undefined}
     */
    this.getArtistsByGenre = function(slug, count, page, divide, cb) {
        var uri = app.get('admin_uri') + '?action=rip_artists_get_all_artists_by_genre_slug&count=' + count; 
     ...
     * @return {undefined}
     */
    this.getArtistsByTag = function(slug, count, page, divide, cb) {
        var uri = app.get('admin_uri') + '?action=rip_artists_get_all_artists_by_tag_slug&count=' + count;
        uri += '&page=' + page + '&slug=' + slug;
        uri += typeof divide !== 'undefined' ? '&divide=true' : '';
